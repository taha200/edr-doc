...
class Account extends Component{
    render(){
              ...
              <ScrollView style={styles.container}>
                  <View style={{width:wp('100%'),backgroundColor:'#f5f5f5',alignItems:'center'}}>
                    <View style={styles.header}>
                        ...
                        <Text style={{fontSize:12,color:'white'}}>BSc, MBBS, DOVI, MD - Dermatologist</Text>
                    </View>
                    <View style={styles.body}>
                        <TouchableOpacity style={{display:'flex',flexDirection:'row',alignItems:'center',width:'100%',padding:20}} onPress={()=>this.props.navigation.navigate('MyPatients')}>
                            <View style={{width:'20%',alignItems:'flex-start'}}>
                                <MIcon name="doctor" size={25} color='#3265b0' />
                            </View>
                            <View style={{width:'80%'}}>
                                <Text  style={{fontSize:16,color:'#3265b0'}}>My Patients</Text>
                            </View> 
                        </TouchableOpacity>
                        ...
                        <View style={{display:'flex',flexDirection:'row',alignItems:'center',width:'100%',padding:20}}>
                            ...
                            <View style={{width:'80%'}}>
                                <Text  style={{fontSize:16,color:'#3265b0'}}>My Profile</Text>
                            </View> 
                        </View>
                        ...
                        <View style={{display:'flex',flexDirection:'row',alignItems:'center',width:'100%',padding:20}}>
                            <View style={{width:'20%',alignItems:'flex-start'}}>
                                <FIcon name="edit" size={25} color='#3265b0' />
                            </View>
                            <View style={{width:'80%'}}>
                                <Text  style={{fontSize:16,color:'#3265b0'}}>Change Password</Text>
                            </View> 
                        </View>
     ...
     AsyncStorage.removeItem("@docuid").then(success=>{
         console.log("deleted")
